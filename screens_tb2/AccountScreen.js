    ...
    <>
      ...
      <List.Section style={styles.container}>
        <List.Item
          ...
          right={props =>
            <TouchableOpacity style={styles.status}>
              <Text style={{color: 'blue', fontWeight: '600', alignItems: 'center', textAlign:'center' }}>Basic</Text>
            </TouchableOpacity>
          }
        /> 
        <List.Section style={{ flexDirection: 'row', width: '100%', height: '40%', justifyContent: 'center', alignItems: 'center', textAlign: 'center', borderBottomLeftRadius: 8, borderBottomRightRadius: 8, borderTopColor: 'white', borderTopWidth: 2,}}>
          <TouchableOpacity style={{ width: '70%', alignItems: 'center', height: '60%', borderRightColor: 'white', borderRightWidth: 2,}}>
            <Text style={styles.text}>Lihat Profil Saya</Text>
          </TouchableOpacity>
          <TouchableOpacity style={{ width: '30%', alignItems: 'center', height: '60%'}}>
